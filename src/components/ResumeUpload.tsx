          ...
          <>
            {onGetApplicationLink && (
              <Button
                ...
                className="h-14 w-full animate-pulse border-primary/50 bg-gradient-to-r from-background to-primary/20 hover:animate-none hover:from-success/20 hover:to-success/40 hover:border-success hover:text-success transition-all duration-300"
              >
